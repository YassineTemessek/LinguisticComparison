...
Output: data/processed/arabic/quran_lemmas_with_ipa.jsonl
...
def main() -> None:
    ...
    ap.add_argument("--output", type=pathlib.Path, default=pathlib.Path("data/processed/arabic/quran_lemmas_with_ipa.jsonl"))
    args = ap.parse_args()
